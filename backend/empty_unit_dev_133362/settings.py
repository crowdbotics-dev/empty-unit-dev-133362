"""
Django settings for empty_unit_dev_133362 project.
...
ROOT_URLCONF = 'empty_unit_dev_133362.urls'
...
WSGI_APPLICATION = 'empty_unit_dev_133362.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_unit_dev_133362 API",
    "DESCRIPTION": "API documentation for empty_unit_dev_133362 App",
    "VERSION": "v1",
}
